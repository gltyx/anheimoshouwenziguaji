#ifndef CLUSTER_PBR_SH_HEADER_GUARD
#define CLUSTER_PBR_SH_HEADER_GUARD
...
uniform hvec4 u_baseColorFactor;
uniform hvec4 u_metallicRoughnessNormalOcclusionFactor;
uniform hvec4 u_emissiveFactorVec;
uniform hvec4 u_hasTextures;
